      ...
      <AnimatePresence>
        {isScrolled && (
          <motion.div
            ...
            className="fixed top-4 right-4 z-50 flex items-center gap-3 px-4 py-2 rounded-full bg-white/70 backdrop-blur-xl border border-white/40 shadow-lg"
          >
            <div className="relative h-5 md:h-6 flex items-center justify-start">
              <img 
                src="/logo.png" 
                alt="Store Logo" 
